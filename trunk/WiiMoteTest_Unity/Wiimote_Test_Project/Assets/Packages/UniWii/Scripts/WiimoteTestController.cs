...
/*			    }*/
	...
	void DoDebugStr (int i) {
		if (wiimoteCount > 0) {
			...
			display += "\n\tButtons Active: ";
			if (wiimote_getButtonA(i)) display += " A ";
			if (wiimote_getButtonB(i)) display += " B ";
			if (wiimote_getButtonHome(i)) display += " Home ";
			if (wiimote_getButtonPlus(i)) display += " + ";
			if (wiimote_getButtonMinus(i)) display += " - ";
			if (wiimote_getButton1(i)) display += " 1 ";
			if (wiimote_getButton2(i)) display += " 2 ";
			if (wiimote_getButtonUp(i)) display += " Up ";
			/* dpad */
			if (wiimote_getButtonDown(i)) display += " Down ";
			if (wiimote_getButtonLeft(i)) display += " Left ";
			if (wiimote_getButtonRight(i)) display += " Right ";
			/* expansion */
			if (wiimote_getButtonNunchuckC(i)) display += " C ";
			if (wiimote_getButtonNunchuckZ(i)) display += " Z ";
		}
		else {
