...
public class MoveScript : MonoBehaviour {
	...
	public void goToLeft(){	
		...
		Debug.Log(selectedObject.name + " naar links");	
		drawNoGrid();
		move();			
	}
	...
	protected void move(){
		Debug.Log(currPointInGridGlobalCoords.x + "\t" + currPointInGridGlobalCoords.z);
		if(gridModus){
			...
			pos.y += selectedObject.renderer.bounds.extents.y;		
			scriptOfSelectedObject.transform.position = pos;
			Debug.Log("Else" + currPointInGridGlobalCoords.x + "\t" + currPointInGridGlobalCoords.z);
		}
	}
